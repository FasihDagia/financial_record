...
def generate_cash_receipt(root,window,receipt_temp,receipt,pay_receip,pay_receip_temp):
    ...
    tk.Label(root,text="Generate Cash Receipts",font=("helvetica",18,"bold")).pack(pady=30)
