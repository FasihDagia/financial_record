    ...
    def generate(root,window,payments_temp,payment,pay_receip,pay_receip_temp):
        ...
        if len(client_temp) == 0:
            if no_entries_2 == 0:
                ...
                balance2 = last_entry_2.get("balance","")
        else:
        ...
        if len(cash_temp) == 0:
            if no_entries_3 == 0:
                ...
                balance3 = last_entry_3.get("balance","")
        else:
...
def save_payments_receipt(payments_temp,payment,pay_receip,pay_receip_temp,type,customers,client_temp,cash,cash_temp):
